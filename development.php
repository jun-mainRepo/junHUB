  ...
  Your browser does not support the audio element.
        ...
        ?>
          <center>
           ...
           <h3><span class="r">R</span>egional  <span class="r">D</span>evelopment <span class="r">I</span>ndicators  <span class="r">f</span>or <span class="r">D</span>evelopment <span class="r">A</span>dministration </h3>
          <table id="customers">
            ...
            <td><?php echo  $row['Source']; ?></td>
              <?php if($_SESSION['division']=='PDIPBD'){?>
