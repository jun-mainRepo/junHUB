...
$query=mysql_query("SELECT * FROM `user_info` WHERE `username` = '" .$_SESSION['admin_login']."'") or die(mysql_error()) ;
 ...
 $_SESSION['log_fname'] = $fname;
  $_SESSION['log_lname'] = $lname;
  $_SESSION['log_position'] = $pos;
  //$_SESSION['log_division'] = $div;
  $_SESSION['log_username'] = $username;
  $_SESSION['log_password'] = $pas;
...
<div><table cellpadding="0" cellspacing="0"><TR VALIGN="MIDDLE"><TD style="background-image: url(http://beemp3.com/player/corner-topleft2.gif);background-repeat: repeat;font-family: Arial, Helvetica, sans-serif;font-size: 12px;vertical-align: bottom;"></td><TD style="background-image: url(http://beemp3.com/player/bkgnd-top2.gif);background-repeat: repeat;font-family: Arial, Helvetica, sans-serif;font-size: 12px;vertical-align: middle;"> Jamie Grace.mp3</td><TD style="background-image: url(http://beemp3.com/player/corner-topright2.gif);background-repeat: repeat;font-family: Arial, Helvetica, sans-serif;font-size: 12px;vertical-align: bottom;"></td></TR><TR VALIGN="MIDDLE"><TD WIDTH="16" style="width: 16px;background-image:url(http://beemp3.com/player/left-ltrow2.gif);"/> </TD><TD style="background-image: url(http://beemp3.com/player/light2.gif);background-repeat: repeat;font-family: Arial, Helvetica, sans-serif;font-size: 11px;vertical-align: bottom;"><audio  controls="controls">
  ...
  Your browser does not support the audio element.
        ...
        <center>
         ...
         <h3><span class="r">R</span>egional  <span class="r">D</span>evelopment <span class="r">I</span>ndicators  <span class="r">f</span>or <span class="r">E</span>conomic <span class="r">S</span>ector </h3>
        <table id="customers">
            ...
            <th class="th_a" scope="col"> Select</th>
            <th class="th_b" scope="col">Sectors</th>
            <th class="th_c" scope="col">Sub-Sectors</th>
            <th class="th_d" scope="col">Classes</th>
            <th class="th_e" scope="col">Time Period</th>
            <th class="th_f" scope="col">Area ID</th>
            <th class="th_g" scope="col">Area Name</th>
            <th class="th_h" scope="col">Indicator</th>
            <th class="th_i" scope="col">Data Value</th>
            <th class="th_j" scope="col">Unit</th>
            <th class="th_k" scope="col">Subgroup</th>
            <th class="th_l" scope="col">Source</th>
