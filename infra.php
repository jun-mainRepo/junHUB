 ...
 */
    ...
    include_once ('function.php');
        ...
        //to make pagination
         $statement = "`tbl_data` where `Sectors` = 'infrastructure'";
...
<div id="bodyPan">
  ...
  Your browser does not support the audio element.
        ...
        ?>
         <center>
        <h3><span class="r">R</span>egional  <span class="r">D</span>evelopment  <span class="r">I</span>ndicator  <span class="r">f</span>or <span class="r">I</span>nfrastructure <span class="r">S</span>ector</h3>
         <table id="customers">
...
?>
  <a class="csv" href="export_infra.php" >Export Infra(RDI)Excel File</a>
