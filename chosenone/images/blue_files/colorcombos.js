...
function validate_search() {	
	if ($('#search_hex').val() == 'Color Search') {
...
$(document).ready(function() {
	...
	$('#search_hex').example('Color Search');
	
	/* Drop-down menus on hover */
	$('$.nav-list li').hover(
		function() { $(this).find('nav-dropdown').show(); },
		function() { $(this).find('nav-dropdown').hide(); },
		function() { $(this).find('nav-dropdown-alt').show(); },
		function() { $(this).find('nav-dropdown-alt').hide(); }
	);
